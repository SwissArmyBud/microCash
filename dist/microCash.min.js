...
z.prototype.on=function(a,b,c,d){var f=this;if(!A(a)){for(var g in a)this.on(g,b,a[g]);return this}C(b)&&(c=b,b="");F(M(a),function(a,g){a=W(V[g]||U[g]||g);var n=a[0],v=a[1];f.each(function(a,g){a=function pa(a){if(!a.namespace||T(v,a.namespace.split("."))){var f=g;if(b){for(var q=a.target;!G(q,b);){if(q===g)return;q=q.parentNode;if(!q)return}f=q;a.__delegate=!0}a.__delegate&&Object.defineProperty(a,"currentTarget",{configurable:!0,get:function(){return f}});q=c.call(f,a,a.data);d&&X(g,n,v,b,pa);
!1===q&&(a.preventDefault(),a.stopPropagation())}};a.guid=c.guid=c.guid||D.guid++;na(g,n,v,b,a)})});return this};z.prototype.ready=function(a){function b(){return a(D)}"loading"!==e.readyState?setTimeout(b):e.addEventListener("DOMContentLoaded",b);return this};
...
z.prototype.insertBefore=function(a){var b=this;D(a).each(function(a,d){var c=d.parentNode;c&&b.each(function(b,f){b=a?f.cloneNode(!0):f;c.insertBefore(b,d)})});return this};z.prototype.before=function(){var a=this;F(arguments,function(b,c){D(c).insertBefore(a)});return this};z.prototype.remove=function(){return this.detach().off()};z.prototype.replaceWith=function(a){return this.before(a).remove()};
z.prototype.text=function(a){return void 0===a?this[0]?this[0].textContent:"":this.each(function(b,c){c.textContent=a})};z.prototype.children=function(a){var b=[];this.each(function(a,d){r.apply(b,d.children)});return L(D(N(b)),a)};z.prototype.find=function(a){for(var b=[],c=0,d=this.length;c<d;c++){var f=y(a,this[c]);f.length&&r.apply(b,f)}return D(N(b))};z.prototype.has=function(a){var b=A(a)?function(b,d){return!!y(a,d).length}:function(b,d){return d.contains(a)};return this.filter(b)};
z.prototype.is=function(a){if(!a||!this[0])return!1;var b=K(a),c=!1;this.each(function(a,f){c=b.call(f,a,f);return!c});return c};z.prototype.next=function(a,b){return L(D(N(H(this,"nextElementSibling",b))),a)};z.prototype.nextAll=function(a){return this.next(a,!0)};z.prototype.not=function(a){if(!a||!this[0])return this;var b=K(a);return this.filter(function(a,d){return!b.call(d,a,d)})};z.prototype.parent=function(a,b){void 0===b&&(b=!1);return L(D(N(H(this,"parentNode",b))),a)};
z.prototype.prev=function(a,b){return L(D(N(H(this,"previousElementSibling",b))),a)};z.prototype.prevAll=function(a){return this.prev(a,!0)};z.prototype.siblings=function(a){var b=[];this.each(function(a,d){r.apply(b,D(d).parent().children(function(a,b){return b!==d}))});return L(D(N(b)),a)};"undefined"!==typeof exports?module.exports=D:h.cash=h.$=D;
})();